...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/SS.X-SandBox.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=Communications.c Main.c UART.c tmr0.c Function.c COBS.c CarDataDictionary.c CarCom.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Communications.p1 ${OBJECTDIR}/Main.p1 ${OBJECTDIR}/UART.p1 ${OBJECTDIR}/tmr0.p1 ${OBJECTDIR}/Function.p1 ${OBJECTDIR}/COBS.p1 ${OBJECTDIR}/CarDataDictionary.p1 ${OBJECTDIR}/CarCom.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/Communications.p1.d ${OBJECTDIR}/Main.p1.d ${OBJECTDIR}/UART.p1.d ${OBJECTDIR}/tmr0.p1.d ${OBJECTDIR}/Function.p1.d ${OBJECTDIR}/COBS.p1.d ${OBJECTDIR}/CarDataDictionary.p1.d ${OBJECTDIR}/CarCom.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/Communications.p1 ${OBJECTDIR}/Main.p1 ${OBJECTDIR}/UART.p1 ${OBJECTDIR}/tmr0.p1 ${OBJECTDIR}/Function.p1 ${OBJECTDIR}/COBS.p1 ${OBJECTDIR}/CarDataDictionary.p1 ${OBJECTDIR}/CarCom.p1

# Source Files
SOURCEFILES=Communications.c Main.c UART.c tmr0.c Function.c COBS.c CarDataDictionary.c CarCom.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/SS.X-SandBox.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/SS.X-SandBox.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/SS.X-SandBox.${IMAGE_TYPE}.map  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --emi=wordwrite --opt=+asm,+asmfile,-speed,+space,-debug,-local --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"        $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/SS.X-SandBox.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/SS.X-SandBox.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/SS.X-SandBox.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/SS.X-SandBox.${IMAGE_TYPE}.map  --double=24 --float=24 --emi=wordwrite --opt=+asm,+asmfile,-speed,+space,-debug,-local --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/SS.X-SandBox.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
